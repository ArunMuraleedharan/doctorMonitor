import 'package:doctor_monitor/Widgets/Authform.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  try{
    ...
    else
    {
      ...
      await FirebaseFirestore.instance.collection("User").doc(authResult.user?.uid).set({'email':email,'username':username});
      setState(() {
        isLoading=false;
      });
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AuthForm(submitFn: _submitAuthForm,isLogin: isLoading,),
